...
const Product = () => {
  return (
    <Container>
      ...
      <Wrapper>
        <ImageContainer>
          <Image src="https://purepng.com/public/uploads/large/purepng.com-pendantjewelryjewellerydiamondpendantchain-1701528883195mihf7.png" />
        </ImageContainer>
        <InfoContainer>
          <Title>Heart Shape Pendant</Title>
          <Description>
